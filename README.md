**简体中文 Windows x64 / Qt6 维护版：** [下载中文版](https://github.com/d4go/klogg/releases/latest) · [使用说明](README.zh-CN.md) · [汉化报告](LOCALIZATION_REPORT.zh-CN.md) · [构建记录](https://github.com/d4go/klogg/actions/workflows/build-zh-cn-windows.yml)
